...
def generate_launch_description():
    ...
    pkg_share = FindPackageShare(package='robot_arm').find('robot_arm')
    default_launch_dir = os.path.join(pkg_share, 'launch')
    default_model_path = os.path.join(pkg_share, 'urdf/robot_arm.urdf.xacro')
    robot_name_in_urdf = 'brazo'
    ...
    start_robot_state_publisher_cmd = Node(
        ...
        'robot_description': launch_ros.descriptions.ParameterValue(Command(['xacro ', default_model_path]), value_type=str),
        }
        ],
